...
public class DiaristaCadastro extends AppCompatActivity {
        ...
        buttonCadastrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (uploadTask != null && uploadTask.isInProgress()) {
                    Toast.makeText(DiaristaCadastro.this, "File Being Uplodaded!", Toast.LENGTH_LONG).show();
                } else {
                    Fileuploader();
                }
            }
        ...
        reference.putFile(imguri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(DiaristaCadastro.this, "Cadastro Realizado com Sucesso!", Toast.LENGTH_LONG).show();
                        try {
                            Thread.sleep(2000);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                        Intent intent = new Intent(DiaristaCadastro.this, MapsActivity.class);
