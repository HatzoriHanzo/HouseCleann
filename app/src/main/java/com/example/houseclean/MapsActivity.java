...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void readDataFirebase(View view) {
        ...
        DatabaseReference mFirebaseDatabase = FirebaseDatabase.getInstance().getReference("Users/" + currentuser);
        ...
        mFirebaseDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                builder.setTitle("Suas infos");
                builder.setMessage("Nome = " + user.getNome() + "\n" +
                        "Cpf = " + user.getCpf() + "\n" +
                        "Idade = " + user.getIdade());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPerfil = findViewById(R.id.perfilUser);
